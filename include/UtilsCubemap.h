...
// void convolveLambertian(const glm::vec3 *data, int srcW, int srcH, int dstW,
//                         int dstH, glm::vec3 *output, int
//                         numMonteCarloSamples);
// void convolveGGX(const glm::vec3 *data, int srcW, int srcH, int dstW, int
// dstH,
